...
const PAGE_URL = "https://finalcutmultimedia.com/video-production-our-services/";
const META_DESC =
  "Explore the full range of creative services from Final Cut Multimedia, including cinematic video production, corporate event coverage, professional photography, car dealership videos, social media content, and high-quality editing solutions.";

// ================= লাইভ সাইটের হুবহু ১০০% SEO =================
export const metadata = {
  title: {
    absolute:
      "Our Services | Video Production, Photography, Editing & Corporate Events | Final Cut Multimedia",
  },
  ...
  "@graph": [
    {
      ...
      "@id": PAGE_URL,
      url: PAGE_URL,
      name: "Our Services | Video Production, Photography, Editing & Corporate Events | Final Cut Multimedia",
      isPartOf: { "@id": "https://finalcutmultimedia.com/#website" },
      datePublished: "2025-10-09T15:58:33+00:00",
      dateModified: "2025-11-05T15:10:07+00:00",
      description: META_DESC,
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Our Services" },
      ],
    },
    {
      "@type": "WebSite",
