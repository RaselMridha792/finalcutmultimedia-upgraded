...
export default function SocialGallery() {
  ...
  return (
    <section className="w-full bg-white text-black py-[12vh] px-5 flex flex-col overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-[8vh] gap-[4vh] md:gap-0">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-gray-600 text-[3.5vw] md:text-[1vw] w-full max-w-none leading-relaxed">
